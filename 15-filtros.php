...
<body>
    <div class="container">
        ...
        <hr>
        <p>Filtros são recursos de análise e limpeza de dados aplicados através de uma 
        função especiais, normalmente as funções <code>filter_var</code> e <code>filter_input</code>
        e também om o uso de <b>constantes</b> de validação/senitização.</p>
